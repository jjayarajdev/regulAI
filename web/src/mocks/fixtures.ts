...
export const kgRules: KgRulesResponse = {
  rules: [
    ...
    // California — mid-onboarding: candidate rules extracted from the
    // uploaded CDI plan, sitting at the human approval gate (drafts). This is
    // what puts the CA card in "Onboarding" and the registry panel at step 3.
    {
      ...kgRuleDefaults,
      id: 'RULE-CA-HO-001',
      name: 'CDI HO — Territory assignment by ZIP as of effective date',
      confidence: 0.94,
      jurisdiction_code: 'US-CA',
      created_by: 'sentinel',
      created_at: '2026-08-01',
      source_doc: 'CDI Homeowners Statistical Plan 2026',
      severity: 'ERROR',
      version: 1,
      status: 'draft',
      effective_from: null,
      effective_until: null,
      citation: 'CDI HO 2026 §4.1 Territory Definitions',
      section: 'CA',
      executable: false,
      currently_active: false,
    },
    {
      ...kgRuleDefaults,
      id: 'RULE-CA-HO-002',
      name: 'CDI HO — Wildfire mitigation discount indicator required',
      confidence: 0.88,
      jurisdiction_code: 'US-CA',
      created_by: 'sentinel',
      created_at: '2026-08-01',
      ...
      effective_from: null,
      effective_until: null,
      citation: 'CDI HO 2026 §6.3 Mitigation Reporting',
      section: 'CA',
      executable: false,
      currently_active: false,
    },
    {
      ...kgRuleDefaults,
      id: 'RULE-CA-HO-003',
      name: 'CDI HO — FAIR Plan companion policy cross-reference',
      confidence: 0.71,
      jurisdiction_code: 'US-CA',
      created_by: 'sentinel',
      created_at: '2026-08-01',
      ...
      effective_from: null,
      effective_until: null,
      citation: 'CDI HO 2026 §9.2 Residual Market Records',
      section: 'CA',
      executable: false,
      currently_active: false,
    },
  ],
  counts: { total: 6, executable: 2, descriptive: 4 },
};

// ── regulator document store (/api/rhs/reg/documents) ──────────────────────
// Backs the standards registry on the Jurisdictions screen: TX + FL live,
// plus the uploaded CDI plan driving the mock California onboarding.
export const regDocuments = {
  documents: [
    {
      document_id: 'doc-tico-plan',
      document_type: 'statistical plan',
      title: 'TICO Statistical Plan — Automobile & Homeowners',
      issuing_body: 'TICO',
      edition: '2026.1',
      effective_date: '2026-01-01',
      word_count: 48200,
      page_count: 214,
      loaded_at: '2026-05-02 09:14:00',
    },
    {
      document_id: 'doc-tx-ins-code',
      document_type: 'statute',
      title: 'Texas Insurance Code §38.001 — Statistical Data Collection',
      issuing_body: 'Texas Legislature',
      edition: '2025',
      effective_date: '2025-09-01',
      word_count: 6100,
      page_count: 4,
      loaded_at: '2026-05-02 09:16:00',
    },
    {
      document_id: 'doc-b118',
      document_type: 'bulletin',
      title: "Commissioner's Bulletin B-2026-Q4-118",
      issuing_body: 'TDI',
      edition: '1',
      effective_date: '2026-01-01',
      word_count: 900,
      page_count: 2,
      loaded_at: '2026-06-01 08:00:00',
    },
    {
      document_id: 'doc-fhcf-call',
      document_type: 'data call',
      title: 'FL Hurricane Catastrophe Fund — Annual Data Call Form',
      issuing_body: 'Florida SBA',
      edition: '2026',
      effective_date: '2026-01-01',
      word_count: 12400,
      page_count: 38,
      loaded_at: '2026-06-20 10:00:00',
    },
    {
      document_id: 'doc-fl-627',
      document_type: 'statute',
      title: 'Florida Statutes 627.351 — Insurance Risk Apportionment',
      issuing_body: 'Florida Legislature',
      edition: '2025',
      effective_date: '2025-07-01',
      word_count: 21000,
      page_count: 15,
      loaded_at: '2026-06-20 10:05:00',
    },
    {
      document_id: 'doc-cdi-ho',
      document_type: 'statistical plan',
      title: 'CDI Homeowners Statistical Plan 2026',
      issuing_body: 'CDI',
      edition: '2026',
      effective_date: '2027-01-01',
      word_count: 41200,
      page_count: 188,
      loaded_at: '2026-08-01 11:30:00',
    },
  ],
};

// ── regulation registry (/api/regulations — NOT under /api/rhs) ────────────
// The onboarding wizard's document store. The uploaded CDI plan already has a
// cached extraction, matching the in-progress California story above.
...
export const regulations: { documents: MockRegulation[] } = {
  documents: [
    {
      slug: 'tico-stat-plan',
      label: 'TICO Statistical Plan — Automobile & Homeowners',
      category: 'Texas statistical plans',
      blurb: 'The TICO reporting plan · 214 pages.',
      size_bytes: 812_000,
      exists: true,
      has_extraction: true,
      has_pdf: true,
    ...
    {
      slug: 'fhcf-data-call',
      label: 'FL Hurricane Catastrophe Fund — Annual Data Call Form',
      category: 'Florida data calls',
      blurb: 'FHCF annual data call instructions · 38 pages.',
      size_bytes: 210_000,
      exists: true,
      has_extraction: true,
      has_pdf: true,
    ...
    {
      slug: 'uploaded-cdi-ho-2026',
      label: 'CDI HO 2026',
      category: 'California — uploaded rulebook',
      blurb: 'Uploaded CDI-HO-2026.pdf · 188 pages · 412,308 chars extracted.',
